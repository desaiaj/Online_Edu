...
function init(b) {
	...
	if (b) {
	    $("#pauseBtn").attr('src', "../../Areas/Users/Style/images/btn_pause.svg");
...
function showHelp() {
    if ($('#openSideBar').attr('src') == '../../Areas/Users/Style/images/btn_back.svg') {
        $('#openSideBar').attr('src', '../../Areas/Users/Style/images/btn_help.svg');
		if (gameState != 0 && gameState != -1 && gameState != 2) {
			$('#fork-ribbon').fadeOut(150, 'linear');
		}
	} else {
        $('#openSideBar').attr('src', '../../Areas/Users/Style/images/btn_back.svg');
		if (gameState == 0 && gameState == -1 && gameState == 2) {
	...
	if ($("#pauseBtn").attr('src') == "../../Areas/Users/Style/images/btn_pause.svg" && gameState != 0 && !infobuttonfading) {
		return;
	}
